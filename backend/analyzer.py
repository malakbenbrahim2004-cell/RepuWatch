...
ECONOMIC_POSITIVE = [
    "leve", "levee de fonds", "milliards", "millions de dh", "millions de dollars",
    "chiffre d affaires", "benefice", "profit", "croissance", "hausse",
    "acquisition", "rachat", "prend le controle", "devient actionnaire",
...
ECONOMIC_NEGATIVE = [
    ...
    "fraude", "corruption", "detournement", "enquete judiciaire",
    "poursuite penale", "plainte deposee", "condamnation", "sanction grave",
    "litige majeur", "scandale",
...
def is_informational(title: str) -> bool:
    t = normalize(title)
    return any(re.search(normalize(p), t) for p in INFORMATIONAL_PATTERNS)
